...
const month_names = ['มกราคม', 'กุมภาพันธ์', 'มีนาคม', 'เมษายน', 'พฤษภาคม', 'มิถุนายน', 'กรกฏาคม', 'สิงหาคม', 'กันยายน', 'ตุลาคม', 'พฤศจิกายน', 'ธันวาคม']
...
Vue.component("create-event-form", {
    template: `<b-form class="create-event-form" @submit="onSubmit" inline>
        <input class="form-control event-title-input" type="text" autocomplete="off"
           placeholder="🐸เขียนกิจกรรม..." v-model="eventTitle"
...
new Vue({
    ...
    data: {
        ...
        dateContext: moment(),
        selectedDate: moment(),
        days: ["จันทร์", "อังคาร", "พุธ", "พฤหัสบดี", "วันศุกร์", "วันเสาร์", "อาทิตย์"],
        //events
        newEventForm: {
            eventTitle: ""
        },
